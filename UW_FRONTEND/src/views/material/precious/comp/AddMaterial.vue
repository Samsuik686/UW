    ...
    <el-dialog
        ...
        <el-form :inline="true" :model="addInfo" class="add-form" label-position="top">
            ...
            <el-form-item label="位号">
                <el-input v-model.trim="addInfo.designator" placeholder="位号"></el-input>
            </el-form-item>
        </el-form>
...
<script>
    ...
    import {addPreciousMaterialTypeUrl, materialAddUrl} from "../../../../plugins/globalUrl";
