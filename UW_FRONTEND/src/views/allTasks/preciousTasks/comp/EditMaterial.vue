    ...
    <el-dialog
        ...
        <el-form :inline="true" :model="editInfo" class="edit-form">
            ...
            <el-form-item label="位号">
                <el-input v-model.trim="editInfo.designator" placeholder="位号"></el-input>
            </el-form-item>
...
<script>
    ...
    import {addPreciousMaterialTypeUrl, addRegularMaterialTypeUrl} from "../../../../plugins/globalUrl";
    ...
    export default {
        ...
        mounted(){
            Bus.$on('setPreciousMaterialDialog',(index,editData)=>{
                ...
                this.editInfo.designator = editData.designator;
        ...
        methods:{
            ...
            submit:function(){
                ...
                if(!this.isPending){
                    this.isPending = true;
                    let options = {
                        url: addPreciousMaterialTypeUrl,
                        data:this.editInfo
                    };
                    axiosPost(options).then(res => {
                        if(res.data.result === 200){
                            this.$alertSuccess('添加成功');
                            Bus.$emit('closePreciousMaterialDialog',this.index,this.editInfo);
                            this.clearForm();
                        }else{
                            errHandler(res.data);
                        }
