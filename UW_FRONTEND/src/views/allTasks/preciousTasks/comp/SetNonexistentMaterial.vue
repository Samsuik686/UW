...
<script>
    ...
    import {taskCreatePreciousIOTaskUrl} from "../../../../plugins/globalUrl";
    ...
    export default {
        ...
        mounted(){
            Bus.$on('setPreciousNonexistentMaterial',(fileName,suppliers,task,data) => {
            ...
            Bus.$on('closePreciousMaterialDialog',(index,editInfo) => {
        ...
        methods:{
            ...
            handleEdit:function(index,row){
                ...
                Bus.$emit('setPreciousMaterialDialog',index,obj);
            },
            submit:function(){
