        ...
        <el-form>
            <el-form-item label="状态更改" v-if="originState === '0' || originState === '1' || originState === '2'">
                <el-select v-model.trim="thisState" placeholder="状态更改" value="" style="width:100%">
                    ...
                    <el-option  label="作废任务" value='4' v-if="originState === '2' || originState === '1'"></el-option>
                </el-select>
            </el-form-item>
...
<script>
    ...
    import {taskCarryBoxUrl, taskUrl, taskWindowsUrl} from "../../../../plugins/globalUrl";
                    ...
                    if (this.thisState > 0 && (this.thisState !== this.originState)) {
                        ...
                        switch (this.thisState) {
                            case '2':
                                ...
                                break;
                            case '4':
                                statusUrl = '/cancelTask';
                                break;
                        }
                        let options = {
                            url: taskCarryBoxUrl + statusUrl,
                            data: {
