  ...
  <div class="boxes" v-loading="isLoading">
    <el-form :inline="true" :model="boxInfo" class="box-form" label-width="70px">
      ...
      <el-form-item style="width:100%;">
        ...
        <el-button type="primary" icon="el-icon-coke-edit" @click="isBatchEditSupplier = true"
                   v-if="(user.type === 1 || user.type === 3)">批量修改料盒客户
        </el-button>
        <el-button type="primary" icon="el-icon-coke-edit" @click="isBatchEditType = true"
                   v-if="(user.type === 1 || user.type === 3)">批量修改料盒类型
        </el-button>
      </el-form-item>
    </el-form>
    <el-table
    ...
    <BatchEditSupplier :is-batch-edit-supplier.sync="isBatchEditSupplier" :selection="selection"
                       :suppliers="suppliers"></BatchEditSupplier>
