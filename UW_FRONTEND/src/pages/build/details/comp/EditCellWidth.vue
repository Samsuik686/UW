<template>
  <div>
    <div class="message"><h3>修改规格</h3></div>
    ...
    <div class="btn-group">
      <div class="form-group row align-items-end">
        <a href="#" class="btn btn-secondary ml-3 mr-4" @click="closeEditPanel">取消</a>
      </div>
      <div class="form-group row align-items-end">
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.param.boxType = this.editData.boxType;
      this.param.srcX = this.editData.srcX;
      this.param.srcY = this.editData.srcY;
      this.param.srcZ = this.editData.srcZ;
      this.param.dst = this.editData.dst;
    ...
    methods: {
      ...
      save: function () {
        ...
        this.$emit('getEditData', this.param, this.index);
      },
