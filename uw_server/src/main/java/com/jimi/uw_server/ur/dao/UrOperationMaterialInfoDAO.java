...
public class UrOperationMaterialInfoDAO {
	...
	private static final String UW_UR_OPERATION_MATERIAL_INFO_MAP = "UW_UR_OPERATION_MATERIAL_INFO_MAP";
	
	private static Object UW_UR_OPERATION_MATERIAL_INFO_MAP_LOCK = new Object();
	
	
	public static void putUrTaskBoxArrivedPack(String urName, UrMaterialInfo urMaterialInfo) {
		synchronized (UW_UR_OPERATION_MATERIAL_INFO_MAP_LOCK) {
			cache.hset(UW_UR_OPERATION_MATERIAL_INFO_MAP, urName, JSON.toJSONString(urMaterialInfo));
		}
	}
	...
	public static void removeUrTaskBoxArrivedPack(String urName) {
		synchronized (UW_UR_OPERATION_MATERIAL_INFO_MAP_LOCK) {
			cache.hdel(UW_UR_OPERATION_MATERIAL_INFO_MAP, urName);
		}
	}
	
	
	public static UrMaterialInfo getUrOperationMaterialInfoByUrName(String urName) {
		String msg = cache.hget(UW_UR_OPERATION_MATERIAL_INFO_MAP, urName);
