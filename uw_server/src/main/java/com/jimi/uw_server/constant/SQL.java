...
public class SQL {
	...
	public static final String GET_MATERIAL_BY_SUPPLIER = "SELECT * FROM material INNER JOIN  material_box ON material.box = material_box.id WHERE material_box.supplier = ? AND material.remainder_quantity > 0 AND material.id != ?";
}
