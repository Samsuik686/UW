...
public class WindowSQL {
	...
	public static final String GET_COUNT_TASK_WINDOWS_SQL = "SELECT * FROM window WHERE bind_task_id IN (SELECT id FROM task WHERE type = 2) ORDER BY id ASC";

	public static final String GET_SAMPLE_TASK_WINDOWS_SQL = "SELECT * FROM window WHERE bind_task_id IN (SELECT id FROM task WHERE type = 7) ORDER BY id ASC";

	public static final String GET_FREE_WINDOWS_SQL = "SELECT * FROM window WHERE `bind_task_id` IS NULL AND auto = ? ORDER BY id ASC";
